...
% 	\end{itemize}
\item Transport measurements of gas diffusion through metal organic frameworks (MOFs) and synthesis thereof.
	% \begin{itemize}
...
\item Provided estimates of spread (standard deviation) through factorial and Simple Monte Carlo (sMC) methods for a system level design which was implemented at the production scale.
...
\item Prepared all publication plots using Python and submitted an \href{https://github.com/andrewrgarcia/scipycon_15}{\textbf{entry}} to the 2015 Scipy John Hunter plotting contest
\end{itemize}}
...
\cvitem{2019--present Ph.D. Research (University of Florida)}{
\newline
{Development of kinetic Monte Carlo (kMC) algorithm and an analytical expression for MOF crystallization process (Python)} }
\cvitem{2018-2019 Ph.D. Research (University of Florida)}{
\newline
{Developed a chemical equilibrium reaction network model to model concentration of chemical species with respect to system changes based on a non-linear system of equations solver (Python)} }
...
\newline
{Created a Monte Carlo simulation algorithm through Python which predicted the results of a [confidential, non-disclosed] characterization method} }
\cvitem{2014-2015 M.S. Research (University of Florida)}{
\newline
\href{https://doi.org/10.1016/j.colsurfa.2017.05.058}
{Proposed a model for crosslinked microsphere size from power-law fits through Minitab and published an \textbf{article} thereof based on fundamental theory } }
...
\newline
(1) Calculate the hydrodynamic radius of polymers from probability density function of random walk
\newline
(2) Simulated the 2-dimensional Ising Model
\newline
(3) Calculated Internal Energy and Pressure from Monte Carlo simulations of a 2-D Lennard-Jones Model]  } }
